...
// //3.2
// const askMinutes = prompt("Введіть якусь кількість хвилин:");
// const numberHours = parseInt(askMinutes) / 60;
// const hours = Math.floor(numberHours % 60);
// const modHours = String(hours).padStart(2, 0);
// const minutes = parseInt(askMinutes) % 60;
// const modMinutes = String(minutes).padStart(2, 0);
// alert(`${modHours}:${modMinutes}`);
